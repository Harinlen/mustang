...
whenToUse: "After making code changes, to catch duplicated logic, hacky patterns, and inefficiencies before committing"
---
...
Perform all three reviews on the changed code:
...
2. **Missed concurrency**: independent async operations run sequentially when they could use `asyncio.gather` or similar
